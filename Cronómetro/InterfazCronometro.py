...
class InterfaceCronometros(Thread):
    ...
    def __init__(self):
        ...
        self.buttonBorrar = Button(self.frame, text="Avanzar/Retroceder")
        self.buttonBorrar.bind("<Button-1>", self.retroceder1)
        self.buttonBorrar.pack(side=RIGHT)
    ...
    def retroceder1 (self,event):
        self.crono.cambiodir()
